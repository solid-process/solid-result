...
class BCDD::Result::TransitionsEnabledWithSourceSingletonNestedTest < Minitest::Test
  ...
  test 'nested transitions tracking' do
    ...
    assert_equal(
      [0, [[1, []], [2, []], [3, []]]],
      result1.transitions[:metadata][:ids][:tree]
    )
    ...
    assert_equal(
      [0, [[1, [[2, []]]], [3, []], [4, []]]],
      result2.transitions[:metadata][:ids][:tree]
    )
    ...
    assert_equal(
      [0, [[1, [[2, []]]], [3, [[4, []]]], [5, []]]],
      result3.transitions[:metadata][:ids][:tree]
    )
    ...
    assert_equal(
      [0, [[1, [[2, []]]], [3, [[4, []]]], [5, [[6, []]]]]],
      result4.transitions[:metadata][:ids][:tree]
    )
