...
module Solid::Result::EventLogs
  class TreeTest < Minitest::Test
    test '#root' do
      ...
      assert_equal('#<Solid::Result::EventLogs::Tree::Node id=0 children.size=0>', tree.root.inspect)
    end
    ...
    test '#parent_value' do
      ...
      assert_equal('#<Solid::Result::EventLogs::Tree::Node id=1 children.size=1>', tree.current.parent.inspect)
    end
    ...
    test '#current_value' do
      ...
      assert_equal('#<Solid::Result::EventLogs::Tree::Node id=2 children.size=0>', tree.current.inspect)
    end
